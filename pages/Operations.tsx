            ...
            {activeTab === 'inspections' ? (
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                {filteredInspections.map(ins => (
                  <motion.div key={ins.id} layout className="group bg-white p-7 rounded-[3rem] border border-slate-100 shadow-xl relative overflow-hidden flex flex-col h-full hover:shadow-2xl transition-all duration-500">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                {filteredDamages.map(dmg => (
                  <motion.div key={dmg.id} layout className="group bg-white p-8 rounded-[3.5rem] border border-slate-100 shadow-xl relative overflow-hidden flex flex-col h-full hover:shadow-2xl transition-all duration-500">
                    <div className="flex justify-between items-start mb-6">
